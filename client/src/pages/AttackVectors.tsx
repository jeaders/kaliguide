...
interface Attack {
  ...
  description: string;
  steps: Array<{ phase: number; title: string; description: string; command: string; explanation: string }>;
}
...
export default function AttackVectors() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0A0A0F] via-[#16161D] to-[#0A0A0F] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-300 font-mono">LOADING ATTACK VECTORS...</p>
        </div>
      </div>
    );
  }
  ...
  if (error || !data) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0A0A0F] via-[#16161D] to-[#0A0A0F] flex items-center justify-center">
        <Card className="p-8 max-w-md bg-gray-900/50 border-red-500/30">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0A0A0F] via-[#16161D] to-[#0A0A0F] cyber-grid">
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_20%_20%,rgba(255,107,53,0.1)_0%,transparent_50%)]" />
        ...
        <div className="container py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Attack Vectors</p>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-12 py-6 bg-gray-900/50 border-orange-500/30 text-white placeholder-gray-500 rounded-xl focus:border-orange-500 focus:ring-2 focus:ring-orange-500/50 font-mono"
            />
          </div>
